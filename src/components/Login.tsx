...
const AnyeLogo = () => (
  ...
  >
    ...
    <g>
      <g style={{fill: '#000', fillOpacity: 1}}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between gap-4">
              <Button
                type="submit"
                disabled={isLoading}
                className="flex-1 max-w-[70%] h-12 bg-black text-white rounded-md hover:bg-gray-800 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2 transition-all duration-200 font-medium"
                tabIndex={4}
              >
                {isLoading ? (
