...
export const TemplateDownload = () => {
  const handleDownloadTemplate = async () => {
    try {
      const response = await fetch('https://dev.huntdigital.com.br/projeto-amazon/template-ofertas');
      ...
      link.href = url;
      link.download = 'template-ofertas.xlsx';
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Baixe o modelo oficial para estruturar suas ofertas corretamente
        </CardDescription>
      </CardHeader>
      <CardContent>
